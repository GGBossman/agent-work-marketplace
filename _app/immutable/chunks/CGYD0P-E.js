import{d0 as b,cR as v,cS as y,cT as x,c$ as $,cY as g,d1 as R,dv as T,cZ as m,cV as C}from"./ZVObxxDF.js";import{n as P,r as h,c as w}from"./BHYwfdzc.js";const s=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:s,subscribe(t){return y(s,()=>t(s))},subscribeKey(t,e){return v(s,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){s.open=!0,s.message=t,s.triggerRect=e,s.variant=o},hide(){s.open=!1,s.message="",s.triggerRect={width:0,height:0,top:0,left:0}}},a=b(_),j=$`
  :host {
    width: 100%;
    display: block;
  }
