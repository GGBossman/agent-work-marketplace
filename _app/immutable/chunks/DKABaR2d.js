import{cV as v,cW as I,cX as R,cY as f,cZ as l,cM as m,cE as d,e6 as ke,di as S,cG as g,dv as N,c$ as Z,cF as $,du as me,d9 as b,d3 as k,d1 as h,cL as O,cH as E,d2 as y,d4 as ze,d5 as Fe,fl as Gt,fm as he,ei as Q,eg as qi,dM as A,fn as tt,d7 as Ai,dO as Ki,dN as Gi,dL as Xi,dj as ft,e7 as Xt,e8 as Yt,fo as Yi,fp as Qi,eb as jt,fq as Ji}from"./ZVObxxDF.js";import{n as c,c as p,U,r as u,b as Ii}from"./BHYwfdzc.js";import{o as w}from"./CMciQX3H.js";import"./dnWXLRhV.js";import"./aUSbfXDV.js";import"./DGZwig7l.js";import"./C8QEeKX5.js";import{W as xa,a as $a}from"./lsodPoJZ.js";import"./j3roWiSb.js";import"./1LHZqbE5.js";import"./BbuICUc6.js";import{H as Qt}from"./CXAPgf6a.js";import{n as Zi}from"./BUjKgvVN.js";import{E as Y}from"./Bfn0oXXX.js";import"./DEXflFMi.js";import"./C7kKYWXq.js";import"./CGYD0P-E.js";import{M as mt}from"./BGCe3rZ3.js";import"./CMeFQ2Ub.js";import{e as Jt,n as Zt}from"./Dr6V9KFX.js";import"./COkdGKt1.js";import"./C3meWaCu.js";import"./C90w_wCL.js";import"./DxgfQuUR.js";import{O as bt}from"./kdIbZNwt.js";import{e as en}from"./DNflU9Zq.js";import"./C9SfhrHM.js";import"./PheJJw0A.js";import{N as tn}from"./DmfK5sOV.js";import"./CP4FQrbQ.js";const nn=v`
  :host {
    display: block;
  }
...
`;var dt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};const mn={sm:"sm-regular",md:"md-regular"};let We=class extends f{constructor(){super(...arguments),this.placement="top",this.variant="fill",this.size="md",this.message=""}render(){return this.dataset.variant=this.variant,this.dataset.size=this.size,l`<wui-icon data-placement=${this.placement} size="inherit" name="cursor"></wui-icon>
      <wui-text variant=${mn[this.size]}>${this.message}</wui-text>`}};We.styles=[I,R,fn];dt([c()],We.prototype,"placement",void 0);dt([c()],We.prototype,"variant",void 0);dt([c()],We.prototype,"size",void 0);dt([c()],We.prototype,"message",void 0);We=dt([p("wui-tooltip")],We);const bn=Z`
  :host {
    width: 100%;
    max-height: 280px;
    overflow: scroll;
...
`;var xo=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Kt=class extends f{constructor(){super(...arguments),this.dappImageUrl=m.state.metadata?.icons,this.walletImageUrl=d.getAccountData()?.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await jt.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){E.showError({message:"Something went wrong. We need to verify your account again."}),h.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await jt.cancelSignMessage().finally(()=>this.isCancelling=!1)}};si([u()],Wt.prototype,"isCancelling",void 0);si([u()],Wt.prototype,"isSigning",void 0);Wt=si([p("w3m-siwx-sign-message-view")],Wt);export{ci as AppKitAccountButton,ui as AppKitButton,pi as AppKitConnectButton,fi as AppKitNetworkButton,li as W3mAccountButton,be as W3mAccountSettingsView,zt as W3mAccountView,xt as W3mAllWalletsView,di as W3mButton,At as W3mChooseAccountNameView,hi as W3mConnectButton,M as W3mConnectView,It as W3mConnectWalletsView,yi as W3mConnectingExternalView,Ct as W3mConnectingMultiChainView,Et as W3mConnectingWcBasicView,we as W3mConnectingWcView,Ci as W3mDownloadsView,xa as W3mFooter,Re as W3mFundWalletView,Si as W3mGetWalletView,wi as W3mNetworkButton,ot as W3mNetworkSwitchView,Le as W3mNetworksView,L as W3mProfileWalletsView,$a as W3mRouter,Wt as W3mSIWXSignMessageView,_t as W3mSwitchActiveChainView,rt as W3mUnsupportedChainView,qt as W3mWalletCompatibleNetworksView,Ei as W3mWhatIsANetworkView,ki as W3mWhatIsAWalletView};
