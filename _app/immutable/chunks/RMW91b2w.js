import{cV as P,cY as I,cE as v,cN as h,cZ as u,cL as z,cF as R,d1 as $,cG as M,dv as K,d4 as F,d5 as Q,cW as O,cX as q}from"./ZVObxxDF.js";import{r as l,n as w,c as A}from"./BHYwfdzc.js";import"./BbuICUc6.js";import"./C8QEeKX5.js";import"./CGYD0P-E.js";import{S as r}from"./BWIqW52a.js";import"./C3meWaCu.js";import"./s51wNjdu.js";import{M as L}from"./BGCe3rZ3.js";import"./COkdGKt1.js";import"./dnWXLRhV.js";const H={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
